...
def spatCorrLevels(R_by_county, B_matrix):
    """
    ...
    delta_min, delta_max, powerMin, powerMax = dG.compute_delta_withG(R_by_county, B_matrix, fileSuffix='Last')
    ...
    delta_I, delta_II, delta_III, delta_IV = compute_spatCorrLevels(R_by_county, B_matrix, fileSuffix='Last')
